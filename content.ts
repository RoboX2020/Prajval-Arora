...
export const VERSIONS = [
  {
    version: 'v2',
    title: 'This page',
    blurb: 'This is the current field: interdisciplinary collisions, a guide for people who want to know me, and a door to work together.',
    href: '/',
  },
  {
    version: 'v1.1',
  ...
  },
  {
    version: 'v1.0',
    title: 'Driving home',
    blurb: 'The original road. You drive a long horizontal journey past tea stalls, posters, and machines.',
    href: '/v1/journey',
  },
  {
    version: 'v1.garage',
    title: 'Internet garage',
    blurb: 'The workshop listing. Every prototype, paper, and community artifact sits as a stall.',
    href: '/v1/garage',
  },
];
