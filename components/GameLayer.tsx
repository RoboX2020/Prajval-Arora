...
export const GameLayer: React.FC<GameLayerProps> = ({ onBackToHome }) => {
  ...
  return (
    <div className="relative h-full min-h-0 w-full flex-1 overflow-hidden bg-blue-100">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 flex justify-center pt-20 pointer-events-none">
